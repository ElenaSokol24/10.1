    ...
    public class JvmComprehension {
        // Класс JvmComprehension загружается в систему ClassLoader'ов
        // и перемещается в Метаспейс для сохранения данных о классе JvmComprehension.
        public static void main(String[] args) {
            ...
            System.out.println("готово"); // 7 В Стэке создается фрейм println,
        ...
        private static void printAll(Object o, int i, Integer ii) {
            ...
            // куда передаются ссылки на Object o, int i и Integer ii. В Стэке созается фрейм toString.
        }
    }
